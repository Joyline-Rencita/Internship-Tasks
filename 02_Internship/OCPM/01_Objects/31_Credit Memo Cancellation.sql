...
SELECT <%=sourceSystem%>  || 'CreditMemoCancellation_' || "VBRK"."MANDT" || "VBRK"."VBELN" 		AS "ID",
    ...
    "VBRK"."VBELN"                                                                         		AS "SystemCreditMemoCancellationNumber",
    "VBRK"."VBELN"                                                                         		AS "DatabaseCreditMemoCancellationNumber"
FROM "VBRK" AS "VBRK"
